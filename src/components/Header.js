  ...
  return (
    <main className=' overflow-hidden relative mx-auto flex min-h-screen w-auto  flex-col items-center justify-center'>
      <div className="text-white flex justify-center">
        ...
        <a className='z-100' href="https://github.com/nejc000l?tab=repositories"><AiFillGithub className='z-0 cursor-pointer p-2 text-[70px] duration-300  ease-in hover:text-black'>
